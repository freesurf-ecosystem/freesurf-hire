  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: typeof window !== 'undefined' ? `${window.location.origin}/investor-signup` : '/investor-signup',
        }
      });
    ...
    try {
      ...
      const { data, error } = await supabase.auth.signUp({
          ...
          options: {
            ...
            emailRedirectTo: typeof window !== 'undefined' ? `${window.location.origin}/investor-signup` : '/investor-signup',
          }
        });
